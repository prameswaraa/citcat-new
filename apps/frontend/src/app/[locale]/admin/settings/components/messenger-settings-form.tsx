...
import { useAdminSettings } from "@/app/[locale]/admin/hooks/use-admin-settings"
import {
  IconRefresh,
  IconPlugConnected,
  IconDeviceFloppy,
...
export function MessengerSettingsForm() {
  const {
    ...
    isTesting,
    isResetting,
  } = useAdminSettings<MessengerSettings>("messenger")

  const [formData, setFormData] = useState<MessengerSettings>(defaultSettings)
  ...
  const handleChange = (field: keyof MessengerSettings) => (
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Messenger Configuration</CardTitle>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Messenger Configuration</CardTitle>
        <CardDescription>
          Configure Facebook Messenger API credentials and webhook settings
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-4">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="messenger-enabled">Enable Messenger Channel</Label>
          </div>
